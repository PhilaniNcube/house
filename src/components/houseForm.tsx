        ...
        <form className="mx-auto max-w-xl py-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mt-4">
               ...
               defaultValue=""
                ...
                {errors.address && <p className="text-white bg-red-500 py-2 px-4">{errors.address.message}</p>}
            ...
            
            {
                address && (
                  <>
                    <div className="mt-4">
                <label htmlFor="image" className="p-4 border-dashed border-4 border-gray-400 block cursor-pointer">
                ...
                {errors.image && <p className="text-white bg-red-500 py-2 px-4">{errors.image.message}</p>}
            </div>

            <div className="mt-4">
                <label htmlFor="bedrooms" className="block">Beds</label>
                <input type="number" id="bedrooms" name="bedrooms" className="p-2" ref={register({
                    required: "Please enter the number of bedrooms", max: {value: 10, message: "House is too big"}, min: {value: 1, message: "Must have at least 1 bedroom"}
                })} />
                {errors.bedrooms && <p className="text-white bg-red-500 py-2 px-4">{errors.bedrooms.message}</p>}
            </div>
